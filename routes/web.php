...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::get('budgets/{budget}/edit', [BudgetController::class, 'editBudget'])->name('budgets.edit');
    ...
    Route::post('budgets/transfer', [BudgetController::class, 'transferBudget'])->name('budgets.transfer');
    ...
    Route::get('reports/realization/{realization}/spp', [ReportController::class, 'downloadPdfSpp'])->name('reports.realization.spp');
    ...
    Route::get('reports/export/rekap-output', [ReportController::class, 'downloadPdfRekapOutput'])->name('reports.export.rekap-output');
