...
<script lang="ts">
    ...
    function handleSubmit(e: Event) {
        ...
        form.post(toUrl(renstraIndex()));
    }
</script>

<AppHead title="Tambah Renstra" />

<div class="p-6 space-y-6 w-full">
    <PageHeader
        title="Tambah Rencana Strategis (Renstra)"
        description="Buat visi, misi, dan indikator strategis baru"
    >
        {#snippet actions()}
            <Link
    ...
    >
        ...
        >
            ...
            >
                {form.processing ? 'Menyimpan...' : 'Simpan Renstra'}
            </button>
        </div>
    </form>
</div>
