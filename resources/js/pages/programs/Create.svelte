...
<script lang="ts">
    ...
    function addIndicator() {
        form.indicators = [
            ...form.indicators,
            { code: '', name: '', target_value: 0, unit_of_measure: '' },
        ];
    }
    ...
    function handleSubmit(e: Event) {
        ...
        form.post(toUrl(programIndex()));
    }
</script>

<AppHead title="Tambah Program" />

<div class="p-6 space-y-6 w-full">
    <PageHeader
        title="Tambah Program Utama"
        description="Buat program DIPA BLU dan indikator keberhasilan program baru"
    >
        {#snippet actions()}
            <Link
                    ...
                    <div class="grid gap-4 grid-cols-3">
                        ...
                        <div class="space-y-1 col-span-2">
                            ...
                            <input
                                ...
                                placeholder="Nama program utama..."
                                class="w-full px-3 py-2 text-sm bg-background border border-zinc-200 dark:border-zinc-800 rounded-lg outline-none focus:border-primary focus:ring-1 focus:ring-primary transition-all"
                                required
                            />
                            {#if form.errors.name}
